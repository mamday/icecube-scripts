...
#      print 'TT: ',tautau 
  ...
  nuSQ = nsq.nuSQUIDSNSI(mutau,tautau,0.0,0.0,beg_ene,end_ene,200,3,nsq.NeutrinoType.neutrino,True,False)
...
#Current output
  #nuSQ.WriteStateHDF5("Test.hdf5")
  print 'Test',nuSQ.EvalFlavor(1,100*nuSQ.units.GeV,0)
